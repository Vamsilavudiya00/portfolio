...
import SagarFullPose from '/public/images/vamsi-1.jpg';
      ...
      <div className="flex w-full flex-col justify-between gap-12 md:flex-row">
        ...
        <div className="flex max-w-xl flex-col gap-6">
          ...
          <Typography>
            ...
            over the past 5 years after starting my web development
            journey, I&apos;m building cutting-edge web applications using
            modern technologies such as React.js, JavaScript, NodeJs,
            Tailwindcss, NextJs and much more.
          </Typography>
          <Typography>
          ...
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            ...
            <ul className="flex list-inside list-disc flex-col gap-2">
              ...
              <Typography component="li">Job Seeker</Typography>
            </ul>
          </div>
          <Typography>
